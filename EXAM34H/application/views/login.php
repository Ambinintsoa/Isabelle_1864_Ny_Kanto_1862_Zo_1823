				...
				<div class="col-md-7 col-lg-5">
					<div class="wrap">
						<div class="login-wrap p-4 p-md-5">
							...
							<form action="<?php echo base_url("login/check"); ?>" class="signin-form" method="POST">
							...
							<p class="text-center">Not a member? <a data-toggle="tab" href="<?php echo base_url('/Redirect_register'); ?>">Sign In</a></p>
						</div>
					</div>
				</div>
			</div>
