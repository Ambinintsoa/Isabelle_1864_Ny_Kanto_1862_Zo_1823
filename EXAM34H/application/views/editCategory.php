            ...
            <div class="col-md-7 col-lg-5">
                <div class="wrap">
                    <div class="login-wrap p-4 p-md-5">
                        ...
                        <form action="<?php echo base_url("EditCat/edited"); ?>" class="signin-form" method="POST">
                            ...
                            <div class="form-group">
                                <button type="submit" class="form-control btn btn-primary rounded submit px-3" style="background-color:rgb(255,195,0);">Edit</button>
                            </div>
                        </form>
