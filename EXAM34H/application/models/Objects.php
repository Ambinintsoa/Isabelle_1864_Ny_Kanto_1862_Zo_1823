...
class Objects extends CI_Model {
    ...
    {
        $request ="select * from     SELECT category.id as idcategory,
        category.name as nomcategory,
        object.id as idcategory,
        object.name as name,
        users.id as iduser,
        users.firstname as firstname,
         users.lastnamen as lastname,
    ...
    FROM object_category
        ...
        JOIN users on object.iduser = users.id where idcategory=%s and ( name like '%%%s%%' or name like '%%%s%%' and iduser!=%s) ";
